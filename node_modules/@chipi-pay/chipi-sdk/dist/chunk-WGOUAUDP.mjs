...
import { RpcProvider, Account, stark, ec, CairoCustomEnum, CairoOption, CairoOptionVariant, CallData, hash, num } from 'starknet';
...
var BACKEND_URL = "https://api.chipipay.com/v1";
...
var ChipiSDK = class {
  ...
  formatAmount(amount, decimals = 18) {
    ...
    if (!amountStr.includes(".")) {
      ...
      console.log("Formatted integer amount:", amountBN2.toString());
...
export { BACKEND_URL, ChipiProvider, ChipiSDK, createArgentWallet, executePaymasterTransaction, useApprove, useCallAnyContract, useChipiContext, useCreateWallet, useStakeVesuUsdc, useTransfer, useWithdrawVesuUsdc };
//# sourceMappingURL=chunk-WGOUAUDP.mjs.map
//# sourceMappingURL=chunk-WGOUAUDP.mjs.map