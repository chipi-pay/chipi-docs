...
declare function useStakeVesuUsdc(): {
    stake: _tanstack_react_query.UseMutateFunction<string, Error, Omit<StakeVesuUsdcParams, "apiPublicKey">, unknown>;
    stakeAsync: _tanstack_react_query.UseMutateAsyncFunction<string, Error, Omit<StakeVesuUsdcParams, "apiPublicKey">, unknown>;
...
declare function useWithdrawVesuUsdc(): {
    withdraw: _tanstack_react_query.UseMutateFunction<string, Error, Omit<WithdrawVesuUsdcParams, "apiPublicKey">, unknown>;
    withdrawAsync: _tanstack_react_query.UseMutateAsyncFunction<string, Error, Omit<WithdrawVesuUsdcParams, "apiPublicKey">, unknown>;
...
export { type ApproveParams as A, type CreateWalletParams as C, type ExecuteTransactionParams as E, type IncrementParams as I, type StakeVesuUsdcParams as S, type TransferParams as T, type WalletData as W, type CreateWalletResponse as a, ChipiSDK as b, type ChipiSDKConfig$1 as c, type WithdrawVesuUsdcParams as d, executePaymasterTransaction as e, type CallAnyContractParams as f, type TransactionParams as g, type SimpleTransactionInput as h, type TransactionInput as i, type TransactionResult as j, ChipiProvider as k, type ChipiProviderProps as l, useCreateWallet as m, useTransfer as n, useApprove as o, useStakeVesuUsdc as p, useWithdrawVesuUsdc as q, useCallAnyContract as r, useChipiContext as u };
