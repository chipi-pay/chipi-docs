...
This is the minimal configuration required to enroll and use biometrics, instead of a PIN, to sign transactions.
<Steps>
<Step title="Register Biometric Along with the pin">
 ```typescript
...
<Step title="Read the PIN triggering the biometric prompt">
  ```typescript
...
<Steps>
<Step title="Create a Wallet with PIN">
...
<Step title="Send Token with Biometric">
 ```typescript
