...
<Steps>
        ...
        <a
          ...
          style="
            ...
            text-decoration: none;
                ...
                cursor: pointer;
          "
              onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='6px_6px_0px rgba(251,146,60,1)'"
              onmouseout="this.style.transform='none'; this.style.boxShadow='4px_4px_0px rgba(251,146,60,1)'"
        >
              💰 Pay with Crypto
        </a>
        ```
  ...
  <Step title="Test your integration" titleSize="h2">
    <Warning>
