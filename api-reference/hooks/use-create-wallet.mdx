...
description: 'Creates a new Argent-compatible wallet on StarkNet. This hook deploys the wallet contract behind the scenes and uses Avnus paymaster to sponsor gas fees, resulting in a frictionless onboarding experience.'
---
